...
import {projectList} from "../data/portfolio.tsx"
                    ...
                    >
                        <div>
                            <div className="flex justify-between items-center mb-6">
                                ...
                                {project.privateProject ? <p className="text-yellow-500/80 bg-yellow-500/10 px-2 py-1 rounded-xl text-sm flex items-center gap-2 font-bold"><Lock className="w-4 h-4" /> Private Project</p> :
                                    <>
                                        <div className="flex gap-4 text-zinc-400">
                                            {project.github || project.live ?
                                                ...
                                                : <p className="text-yellow-500/80 bg-yellow-500/10 px-2 py-1 rounded-xl text-sm flex items-center gap-2 font-bold"><Lock className="w-4 h-4" /> Private Project</p>}
                                        </div>
                                    </>
                                }
                            </div>
