            ...
            <section id="home" className="min-h-screen flex items-center justify-center pt-20 sm:pt-24 px-4 sm:px-6 md:px-12 lg:px-24 max-w-7xl mx-auto relative">
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4 w-full sm:w-auto">
                    ...
                    <button
                        ...
                        className="px-8 py-4 bg-zinc-900 hover:bg-zinc-800 active:scale-95 text-zinc-300 hover:text-white border border-white/10 hover:border-white/20 font-semibold rounded-xl transition-all cursor-pointer"
                    >
                        Contact Me
                    </button>
                </div>
